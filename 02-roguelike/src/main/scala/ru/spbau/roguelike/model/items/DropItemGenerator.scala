...
case class ItemDrop(item: Item, dropChanceContribution: Int)

object DropItemGenerator {
  private val generator = new Random()

  private val drops = List(
  ...
  private def findSelectedItem(contributionIndex: Int, dropIndex: Int): Option[Item] =
